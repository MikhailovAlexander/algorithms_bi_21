...
с названием team_name_manual_task_5_bi, указав вместо team_name название команды.
3. Создать запрос на сляние ветки с решением с данной веткой manual_task_5_bi.
